...
public:
    static void createParticleQuad(sf::VertexArray& target, sf::Vector2f pos); ///convenience function used to create a basic quad for a particle

    virtual ~ParticleGenerator(){}
    virtual size_t generate(sf::VertexArray& target){return 0;}; ///main function of the generator: to overload
};
...
public:
     ...
     */
    void addParticles(ParticleGenerator* generator, ParticleUpdater* updater);
